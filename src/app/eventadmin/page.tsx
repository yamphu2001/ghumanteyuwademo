  ...
  return (
    <div className="min-h-screen bg-[#f4f6f9] flex flex-col items-center py-8 md:py-16 px-4 md:px-6 font-sans">
      ...
      <div className="w-full max-w-2xl">
        ...
        <div className="space-y-3">
          {events.map((ev) => (
            <div key={ev.id} className="bg-white border p-4 rounded-2xl flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div className="flex items-center gap-3 cursor-pointer" onClick={() => onSelect(ev.id)}>
              ...
              <div className="flex items-center justify-between sm:justify-end gap-2 border-t sm:border-0 pt-3 sm:pt-0">
                <span className="text-[9px] px-2 py-1 rounded-full border bg-green-50 text-green-700">{ev.status}</span>
                <div className="flex gap-1">
                    ...
                    <button onClick={() => onSelect(ev.id)} className="bg-slate-800 text-white text-[10px] px-3 py-1.5 rounded-lg">Select</button>
                </div>
              </div>
            </div>
          ))}
