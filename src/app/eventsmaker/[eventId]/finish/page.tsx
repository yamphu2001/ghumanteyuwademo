    ...
    const unsubscribeAuth = onAuthStateChanged(auth, async (user) => {
      if (user && eventId) {
        try {
          ...
          // 2. Fetch Player Username explicitly from the Firestore 'users' collection
          ...
          // 3. Establish Live Realtime Snapshot Listener on Player Log document
          ...
          unsubscribeLog = onSnapshot(playerLogRef, (playerLogSnapshot) => {
            ...
            if (playerLogSnapshot.exists()) {
              ...
              // Fallback priority routing for dynamic structural synchronization updates
            ...
            // Update aggregated dynamic UI state container instantly
            setEndStats({
              totalTime: calculatedTimeTaken,
