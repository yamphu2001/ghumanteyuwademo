      ...
      if (map.getSource(sourceId)) {
        ...
        map.addLayer({
          ...
          paint: {
            ...
            'fill-extrusion-opacity': window.innerWidth < 768 ? 0.8 : 0.9
          }
        });
        ...
        map.addLayer({
          ...
          layout: {
            ...
            'text-size': [
              ...
              15, 10,  // At zoom 15, text is 10px
              18, 14   // At zoom 18, text is 14px
            ],
            'text-variable-anchor': ['top', 'bottom', 'left', 'right'], // Better for mobile crowding
            'text-padding': 10,
